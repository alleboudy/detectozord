...
int main(int argc, char* argv[])
{
	...
	string dataMainPath = "C:\\Users\\ahmad\\Downloads\\dataset\\models\\models\\";
	string outputCloudsDir = "C:\\Users\\ahmad\\Downloads\\dataset\\models\\models\\trainingNormalized";
	for (auto modelsIT : directory_iterator(dataMainPath))
	{
		...
		float smallestx = std::numeric_limits<float>::min(), smallesty = std::numeric_limits<float>::min(), smallestz = std::numeric_limits<float>::min();
